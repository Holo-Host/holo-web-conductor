# Contributing to Holo Web Conductor
...
| `"Offset outside DataView bounds"` | Wrong encoding format entirely | Double-encoding when single is needed, or vice versa |
...
2. Research in reference sources (see below) before looking elsewhere
...
- **Reference sources** (prefer these over external documentation):
  1. Holochain: https://github.com/holochain/holochain
  2. @holochain/client: https://github.com/holochain/holochain-client-js
  3. Linker: https://github.com/holo-host/h2hc-linker
