...
3. **5.6.3**: create mocks for these functions that return believable data with those types
...
6. **5.6.2**: add manual testing affordances to the wasm-test UI with display functions so that hashes appear as B64 in the console results.
